/**
 * TrackLens - Update Check Hook
 *
 * Checks for new versions of TrackLens by querying the GitHub releases API.
 * Shows feature highlights for milestone releases.
 *
...
const GITHUB_API = 'https://api.github.com/repos/scooter-lacroix/Maestro/releases/latest';
...
const FEATURE_HIGHLIGHTS: Record<string, FeatureHighlight> = {
  '0.5.0': {
    ...
    description: 'Review git diffs with inline annotations. Run /tracklens-review to try it.',
  },
};
...
/**
 * Hook to check for TrackLens updates
 * @returns UpdateInfo if an update is available, null otherwise or on error
 */
      ...
      try {
        ...
        if (previewVersion) {
          ...
          setUpdateInfo({
            ...
            releaseUrl: `https://github.com/scooter-lacroix/Maestro/releases/tag/v${cleanPreview}`,
