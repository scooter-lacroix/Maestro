/**
 * TrackLens UI - Image Annotator
 *
 * Modal component for annotating images with drawings.
 *
        ...
        {initialName && (
          <div className="flex items-center gap-2 w-full max-w-xs">
            ...
            <input
              ...
              className="flex-1 px-3 py-2 text-xs bg-background shadow-neu-inset rounded-xl text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50"
