/**
 * TrackLens UI - Annotation Sidebar Component
 *
 * Simple sidebar for review annotations.
 *
...
export const AnnotationSidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <div className="w-[min(22rem,32vw)] min-w-[16rem] border-l border-border/50 bg-card/50 backdrop-blur-sm h-full flex flex-col">
            ...
            >
              <div className="flex justify-between items-start mb-1">
                ...
                <button
                  ...
                  className="opacity-0 group-hover:opacity-100 text-muted-foreground hover:text-destructive p-1 rounded hover:bg-destructive/10"
                >
