/**
 * TrackLens UI - Plan Clean Diff View
 *
 * Rendered/clean diff mode showing the new plan content rendered as markdown,
 * with colored left borders indicating what changed.
 *
