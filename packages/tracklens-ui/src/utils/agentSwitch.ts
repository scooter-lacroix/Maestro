/**
 * TrackLens Agent Switch Settings Utility
 *
 * Manages settings for automatic agent switching after document approval.
 ...
 *
 * REBRANDED: Storage keys changed from 'plannotator-agent-' to 'tracklens-agent-'
 */

import { storage } from './storage';

const STORAGE_KEY = 'tracklens-agent-switch';
const CUSTOM_NAME_KEY = 'tracklens-agent-custom';
