/**
 * TrackLens - Permission Mode Settings Utility (Claude Code only)
 *
 * Manages the preferred permission mode to restore after review approval.
...
const STORAGE_KEY_MODE = 'tracklens-permission-mode';
const STORAGE_KEY_CONFIGURED = 'tracklens-permission-mode-configured';
