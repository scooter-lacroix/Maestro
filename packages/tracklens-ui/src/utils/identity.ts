/**
 * TrackLens Identity System
 *
 * Generates anonymous identities for collaborative annotation.
 * Format: {adjective}-{noun}
 * Examples: "swift-falcon", "gentle-crystal"
 *
 * REBRANDED: Removed 'tater' references from identity format
 * Storage key changed from 'plannotator-identity' to 'tracklens-identity'
 */

import { uniqueUsernameGenerator, adjectives, nouns } from 'unique-username-generator';
import { storage } from './storage';

const STORAGE_KEY = 'tracklens-identity';

/**
 * Generate a new TrackLens identity
 */
