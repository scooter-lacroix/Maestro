...
// ../../node_modules/unique-username-generator/dist/data/adjectives.js
var require_adjectives = __commonJS({
  "../../node_modules/unique-username-generator/dist/data/adjectives.js"(exports) {
    "use strict";
...
// ../../node_modules/unique-username-generator/dist/data/nouns.js
var require_nouns = __commonJS({
  "../../node_modules/unique-username-generator/dist/data/nouns.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = [
      "abatement",
...
// ../../node_modules/unique-username-generator/dist/data/index.js
var require_data = __commonJS({
  "../../node_modules/unique-username-generator/dist/data/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.nouns = exports.adjectives = void 0;
    var adjectives_1 = require_adjectives();
    exports.adjectives = adjectives_1.default;
    var nouns_1 = require_nouns();
    exports.nouns = nouns_1.default;
  }
});

// ../../node_modules/unique-username-generator/dist/utils/random.js
var require_random = __commonJS({
  "../../node_modules/unique-username-generator/dist/utils/random.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.createSeededRandomInt = exports.getRandomInt = void 0;
    function getCrypto() {
      const g = typeof globalThis !== "undefined" ? globalThis : void 0;
      return g && g.crypto ? g.crypto : void 0;
    }
    var fallbackSeed = (Date.now() ^ 2654435769) >>> 0;
    ...
    function getRandomValues(length) {
      ...
      if (cryptoApi && typeof cryptoApi.getRandomValues === "function") {
        const buffer2 = new Uint32Array(length);
        cryptoApi.getRandomValues(buffer2);
        return buffer2;
      }
    ...
    var getRandomInt = (minInclusive, maxInclusive) => {
...
// ../../node_modules/unique-username-generator/dist/data/profanity.js
var require_profanity = __commonJS({
  "../../node_modules/unique-username-generator/dist/data/profanity.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// ../../node_modules/unique-username-generator/dist/index.js
var require_dist = __commonJS({
  "../../node_modules/unique-username-generator/dist/index.js"(exports) {
    ...
    function generateUniqueAsync(config, isTaken, maxAttempts = 1e3) {
    ...
    function generateMany(options) {
      ...
      for (let i = 0; i < count; i++) {
        ...
        if (unique) {
          let spins = 0;
          while (seen.has(candidate) && spins < 1e3) {
    ...
    var randomNumber = (maxNumber) => {
      ...
      switch (maxNumber) {
        ...
        case 3:
          ...
          break;
        case 4:
          randomNumberString = Math.floor((0, random_1.getRandomInt)(1e3, 9e3)).toString();
          break;
        case 5:
          randomNumberString = Math.floor((0, random_1.getRandomInt)(1e4, 9e4)).toString();
          break;
        case 6:
          randomNumberString = Math.floor((0, random_1.getRandomInt)(1e5, 9e5)).toString();
          break;
        default:
          randomNumberString = "";
          break;
    ...
    function generateFromEmail(email, second) {
      ...
      const opts = typeof second === "object" && second !== null ? second : { randomDigits: typeof second === "number" ? second : void 0 };
      const stripLeading = opts.stripLeadingDigits !== false;
      ...
      const digits = typeof opts.randomDigits === "number" ? opts.randomDigits : void 0;
    ...
    function uniqueUsernameGenerator(config) {
      ...
      if (!config.dictionaries) {
        ...
        const blocklist = Array.from(/* @__PURE__ */ new Set([...(_a = config.profanityList) !== null && _a !== void 0 ? _a : profanity_1.DEFAULT_PROFANITY, ...(_b = config.exclude) !== null && _b !== void 0 ? _b : []])).filter((w) => !!w);
    ...
    var data_2 = require_data();
    Object.defineProperty(exports, "adjectives", { enumerable: true, get: function() {
      return data_2.adjectives;
    } });
    Object.defineProperty(exports, "nouns", { enumerable: true, get: function() {
      return data_2.nouns;
    } });
    var profanity_2 = require_profanity();
    Object.defineProperty(exports, "DEFAULT_PROFANITY", { enumerable: true, get: function() {
    ...
    function renderTemplate(template, dictionaries, randInt, separator, randomDigits) {
      ...
      return template.replace(tokenRegex, (match) => {
        ...
        if (inner.startsWith("digits")) {
          ...
          return randomNumber(Number.isFinite(n) ? n : void 0);
        }
...
//# sourceMappingURL=unique-username-generator.js.map
