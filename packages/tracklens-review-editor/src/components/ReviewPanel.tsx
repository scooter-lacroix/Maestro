...
export const ReviewPanel: React.FC<ReviewPanelProps> = ({
  ...
  return (
    <aside className="bg-surface-glass backdrop-blur-xl flex flex-col flex-shrink-0 fabric-border-l" style={{ width: width ?? 288 }}>
      {/* Header */}
                  ...
                  {fileAnnotations.map((annotation) => {
                    ...
                    return (
                      <div
                        ...
                        className={`group relative p-2.5 rounded-lg border cursor-pointer transition-all ${isSelected
