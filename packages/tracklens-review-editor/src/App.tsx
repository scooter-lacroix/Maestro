...
import { getIdentity } from '@maestro/tracklens-ui/utils/identity';
...
const ReviewApp: React.FC = () => {
  ...
  // Resizable panels
  const panelResize = useResizablePanel({ storageKey: 'tracklens-review-panel-width' });
  const fileTreeResize = useResizablePanel({
    storageKey: 'tracklens-filetree-width',
