...
func TestSessionPrefix(t *testing.T) {
	if SessionPrefix != "maestro_" {
		t.Errorf("SessionPrefix = %s, want maestro_", SessionPrefix)
	}
}
...
func TestReconnectSession(t *testing.T) {
	...
	sess := ReconnectSession("maestro_test_abc123", "test", "/tmp", "claude")

	if sess.Name != "maestro_test_abc123" {
		t.Errorf("Name = %s, want maestro_test_abc123", sess.Name)
	}
...
func TestReconnectSessionHasStateTracker(t *testing.T) {
	sess := ReconnectSession("maestro_test_123", "my-project", "/home/user/project", "claude")
...
func TestReconnectSessionWithStatusIdle(t *testing.T) {
	...
	sess := ReconnectSessionWithStatus("maestro_test_123", "my-project", "/tmp", "claude", "idle")
...
func TestReconnectSessionWithStatusWaiting(t *testing.T) {
	...
	sess := ReconnectSessionWithStatus("maestro_test_456", "other-project", "/tmp", "claude", "waiting")
...
func TestReconnectSessionWithStatusActive(t *testing.T) {
	...
	sess := ReconnectSessionWithStatus("maestro_test_789", "active-project", "/tmp", "claude", "active")
...
func TestAppRestartPersistenceFlow(t *testing.T) {
	...
	sess := ReconnectSessionWithStatus("maestro_project_abc", "project", "/tmp", "claude", "idle")
...
func TestNewSessionsStartYellow(t *testing.T) {
	...
	sess := ReconnectSessionWithStatus("maestro_new_xyz", "new-project", "/tmp", "claude", "waiting")
...
func TestSessionLogFile(t *testing.T) {
	...
	assert.Contains(t, logFile, ".maestro/logs/")
	assert.Contains(t, logFile, "maestro_test-log")
