...
type GlobalSearchResult struct {
	...
	InApp bool      // True if this session is already in Maestro
	AppInstanceID  string    // Maestro instance ID if exists
}
...
// MarkInApp marks which results are already in Maestro
func (gs *GlobalSearch) MarkInApp(instances []*session.Instance) {
