...
type MCPPoolSettings struct {
	...
	// AutoStart starts pool when maestro-tui launches (default: true)
	...
	// ShutdownOnExit stops HTTP servers when maestro-tui quits (default: true)
...
func CreateExampleConfig() error {
	...
	exampleConfig := `# Maestro User Configuration
...
# Log file management
# Agent-deck logs session output to ~/.maestro-tui/logs/ for status detection
